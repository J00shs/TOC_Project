...
public class howToPlayMenu extends JPanel{
        public howToPlayMenu() {
                ...
                add(new JLabel("<html><p1> 'W' Key: use the up arrow key to move the snake up</p1>"), gbc);
                add(new JLabel("<html><p1> 'S' Key: use the down arrow key to move the snake down</p1>"), gbc);
                add(new JLabel("<html><p1> 'A' Key: use the left arrow key to move the snake up</p1>"), gbc);
                add(new JLabel("<html><p1> 'D' Key: use the right arrow key to move the snake up</p1>"), gbc);
